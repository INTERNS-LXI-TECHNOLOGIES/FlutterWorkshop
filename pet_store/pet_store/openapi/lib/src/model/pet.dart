...
class PetStatusEnum extends EnumClass {
  ...
  static PetStatusEnum available = _$petStatusEnum_available;

  /// pet status in the store
  @BuiltValueEnumConst(wireName: r'pending')
  static PetStatusEnum pending = _$petStatusEnum_pending;

  /// pet status in the store
  @BuiltValueEnumConst(wireName: r'sold')
  static PetStatusEnum sold = _$petStatusEnum_sold;

  static Serializer<PetStatusEnum> get serializer => _$petStatusEnumSerializer;

  PetStatusEnum._(String? name) : super(name!);
